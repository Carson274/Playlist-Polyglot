        ...
        <>  
            ...
            <div className="App flex flex-col grey-background text-neutral min-h-screen">
                <div className="flex flex-col md:flex-row">
                    <div className="p-10 information flex flex-col w-full md:w-2/3">
                    ...
                    <div className="w-full md:w-1/3 p-5 md:p-10 flex flex-col items-center text-center max-h-[80vh]">
